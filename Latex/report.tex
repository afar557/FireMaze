...
\begin{solution} \hfill \\
	Largest dimension we can solve using $DFS$ at p = 0.3 in $less$ than a minute: \\
	Largest dimension we can solve using $BFS$ at p = 0.3 in $less$ than a minute: \\
	Largest dimension we can solve using $A*$ at p = 0.3 in $less$ than a minute: \\
\end{solution}
